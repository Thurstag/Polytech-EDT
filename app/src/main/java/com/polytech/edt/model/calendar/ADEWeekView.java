...
import static com.polytech.edt.util.WeekViewUtil.isAllDay;
import static com.polytech.edt.util.WeekViewUtil.splitWeekViewEvents;
...
public class ADEWeekView extends View {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            switch (mCurrentScrollDirection) {
                ...
                case RIGHT:
                    ...
                    ViewCompat.postInvalidateOnAnimation(ADEWeekView.this);
                    break;
                case VERTICAL:
    ...
    public ADEWeekView(Context context) {
        this(context, null);
    }

    public ADEWeekView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ADEWeekView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEventRects != null && mEventRects.size() > 0) {
            for (int dayNumber = 0;
                ...
                for (int i = 0; i < mEventRects.size(); i++) {
                    ...
                    if (isSameDay(mEventRects.get(i).event.getStartTime(), day) && isAllDay(mEventRects.get(i).event)) {
    ...
    private void drawEvents(Calendar date, float startFromPixel, Canvas canvas) {
        if (mEventRects != null && mEventRects.size() > 0) {
            for (int i = 0; i < mEventRects.size(); i++) {
                if (isSameDay(mEventRects.get(i).event.getStartTime(), date) && !isAllDay(mEventRects.get(i).event)) {
        ...
        for (EventRect eventRect : eventRects) {
            ...
            for (List<EventRect> collisionGroup : collisionGroups) {
                for (EventRect groupEvent : collisionGroup) {
                    if (isEventsCollide(groupEvent.event, eventRect.event) && isAllDay(groupEvent.event) == isAllDay(eventRect.event)) {
